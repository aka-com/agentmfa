...
pub enum AuditKind {
    ...
    SecretRevealed,
    SecretCopied,
    OnePasswordIntegrationAdded,
    OnePasswordIntegrationUpdated,
    OnePasswordIntegrationDeleted,
    OnePasswordSecretLinked,
    ConnectionAdded,
    ConnectionUpdated,
    ConnectionDeleted,
...
impl AuditKind {
    ...
    pub fn icon(&self) -> &'static str {
        match self {
            ...
            AuditKind::OnePasswordIntegrationAdded => "plug",
            AuditKind::OnePasswordIntegrationUpdated => "refresh",
            AuditKind::OnePasswordIntegrationDeleted => "unplug",
            AuditKind::OnePasswordSecretLinked => "link",
