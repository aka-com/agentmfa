...
//! connection, or changing a connection's capability — complete only after a
//! native LocalAuthentication (Touch ID / account password) sheet that the
//! webview cannot render, forge, or dismiss. The webview
